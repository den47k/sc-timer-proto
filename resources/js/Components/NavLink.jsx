...
export default function NavLink({
    ...
    return (
        ...
        <Link
          {...props}
          className={
            'relative flex intems-center justify-start py-3 font-roboto text-sm hover:text-white hover:opacity-100 transition-all duration-100 cursor-pointer ' +
            (active ? 'text-white opacity-100' : 'text-gray-200 opacity-80') +
            className
          }
        >
          {children}
